...
public class FormBiayaLain extends javax.swing.JInternalFrame {
    ...
    private void tampilData(String filter){
        Object[] judulKolom = {"No", "id", "Akun id", "Nama Akun","Nama Biaya","Jumlah","Jurusan","Status"};
        DefaultTableModel modelAkun = new DefaultTableModel(null,judulKolom);
        tableData.setModel(modelAkun);

        try{
            String sql="select biaya_lain.id, akun_id, nama_akun, nama_biaya, jumlah, jurusan, nama_jurusan, status from biaya_lain INNER JOIN jurusan on biaya_lain.jurusan=jurusan.id INNER JOIN akun on biaya_lain.akun_id=akun.kode where akun_id like '%"+filter+"%' or nama_akun like '%"+filter+"%'";
            ...
            while (rs.next()) {
                ...
                String[] barisBaru = {Integer.toString(no), txtId, txtAkunId, txtNamaAkun, txtNamaBiaya, txtJumlah, txtNamaJurusan, txtStatus};
            ...
            .addGroup(dialogFormLayout.createSequentialGroup()
                ...
                .addGroup(dialogFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(dialogFormLayout.createSequentialGroup()
                        ...
                        .addGroup(dialogFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(dialogFormLayout.createSequentialGroup()
                                .addComponent(cbstatus, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        ...
        if (mode == "tambah") {
            ...
            sql = "update biaya_lain set akun_id='"+txtAkunId+"',"
