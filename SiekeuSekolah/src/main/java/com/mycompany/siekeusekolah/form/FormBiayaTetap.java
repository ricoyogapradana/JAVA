...
public class FormBiayaTetap extends javax.swing.JInternalFrame {
    ...
    private void tampilData(String filter){
        Object[] judulKolom = {"No", "id", "Akun id", "Nama Akun","Nama Biaya","Jumlah","Jurusan","Semester","Angkatan"};
        DefaultTableModel modelAkun = new DefaultTableModel(null,judulKolom);
        tableData.setModel(modelAkun);

        try{
            String sql="select biaya_tetap.id, akun_id, nama_akun, nama_biaya, jumlah, jurusan, smt, tahun_angkatan, nama_jurusan from biaya_tetap INNER JOIN jurusan on biaya_tetap.jurusan=jurusan.id INNER JOIN akun on biaya_tetap.akun_id=akun.kode where akun_id like '%"+filter+"%' or nama_akun like '%"+filter+"%'";
            ...
            while (rs.next()) {
                ...
                String[] barisBaru = {Integer.toString(no), txtId, txtAkunId, txtNamaAkun, txtNamaBiaya, txtJumlah, txtNamaJurusan, txtSmt, txtTahunAngkatan};
            ...
            .addGroup(dialogFormLayout.createSequentialGroup()
                ...
                .addGroup(dialogFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(dialogFormLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(semester, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(dialogFormLayout.createSequentialGroup()
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
        ...
        String txtSmt = semester.getText();
